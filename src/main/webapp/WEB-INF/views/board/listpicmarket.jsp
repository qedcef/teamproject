  ...
  ======================================================== -->
				...
				<div class="page-blog">
					...
					<main id="main">
						...
						<!-- End Breadcrumbs -->
						 <div><button type="button" onclick="location.href='/pap/board/listpicmarket?ca=${scri.ca_num}&searchType=${scri.searchType}&keyword=${scri.keyword}&sort=viewCount'" class="btn btn-outline-dark float-right " >조회순</button>
							<button type="button" onclick="location.href='/pap/board/listpicmarket?ca=${scri.ca_num}&searchType=${scri.searchType}&keyword=${scri.keyword}&sort=likeCount'" class="btn btn-outline-dark float-right" data-bs-toggle="button" >좋아요순</button>
							<button type="button" onclick="location.href='/pap/board/listpicmarket?ca=${scri.ca_num}&searchType=${scri.searchType}&keyword=${scri.keyword}&sort=bno'" class="btn btn-outline-dark float-right ">최신순</button>
  						</div>
						<!-- ======= Blog Section ======= -->
