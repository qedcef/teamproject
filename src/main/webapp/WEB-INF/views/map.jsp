		...
		<div id="layoutSidenav_content">
			...
			<main>
				...
				<form action="FreeBoardWriteServlet" method="post">
					<label for="pl_name">장소명:</label> <input type="text" name="pl_name"
						id="pl_name"> 
					<label for="pl_lat">위도:</label> <input
						type="text" name="pl_lat" id="pl_lat" > 
						<label
						for="pl_lon">위도:</label> <input type="text" name="pl_lon"
						id="pl_lon"> 
						
						<label>카테고리</label> <select
						name="pl_category" id="pl_category" value="${map.pl_category }">
				...
				<div id="cateBtn">
					...
					<button class="ca_5 cateBtn" id="etc" value="기타">기타</button>
				</div>
				<!-- /구 카테고리-->
