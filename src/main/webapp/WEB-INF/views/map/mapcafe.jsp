		...
		<div id="layoutSidenav_content">
			...
			<main>
				...
				<div class="breadcrumbs d-flex align-items-center"
					style="background-image: url('${contextPath}/resources/test/img/cafe.jpg'); background-size:cover;">
					<div
				...
				<table class="table table-hover" id="products">
					<thead>
						<tr>
							...
							<th>링크</th>
							<th>*</th>
						<c:if test="${user.ui_grade=='관리자' or user.ui_grade=='매니저' or user.ui_grade=='평회원'}">					
							<th>수정</th>
							<th>삭제</th>
								</c:if>
						</tr>
